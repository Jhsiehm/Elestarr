...
export default function Hiring() {
  ...
  return (
    <SiteShell title="Hiring · Elestar">
      ...
      {/* 02 COST - employers. What access includes. */}
      ...
      {/* 03 COUNT - employers. Honest inventory. */}
      <section className="site-section">
      ...
      {/* 04 DESK - employers. How a round is skipped. */}
      <section className="site-section">
      ...
      {/* 05 NDA - employers. Policy in the open. */}
      <section className="site-section">
      ...
      {/* 06 FORGERY - employers. DKIM in plain language. */}
      <section className="site-section">
      ...
      {/* 07 OUTCOME - employers. The strongest objection. */}
      <section className="site-section">
      ...
      {/* 08 CLOSE - employers. Concrete next step. */}
      <section className="site-section">
